...
from QRServer.common.messages import AddStatsRequest, AssignNextPowerCountMessage, AssignPowerSquareMessage, \
    ...
    ServerRankingResponse, ServerRankingThisMonthResponse, SetCommentRequest, SettingsArenaSizeMessage, \
...
class MessagesTest(unittest.TestCase):
    ...
    def test_every_message_has_mapping(self):
        ...
        self.assertEqual(messages.get_message_type_from_id(25), ServerRankingResponse)
        self.assertEqual(messages.get_message_type_from_id(26), ServerRankingThisMonthResponse)
        self.assertEqual(messages.get_message_type_from_id(27), LobbyStateResponse)
        self.assertEqual(messages.get_message_type_from_id(28), OpponentDeadResponse)
        self.assertEqual(messages.get_message_type_from_id(29), VoidScoreResponse)

        self.assertEqual(messages.get_message_type_from_id(30), NameTakenResponseNo)
        self.assertEqual(messages.get_message_type_from_id(31), NameTakenResponseYes)
        self.assertEqual(messages.get_message_type_from_id(32), ChangePasswordResponseOk)
        self.assertEqual(messages.get_message_type_from_id(33), UsePowerMessage)
        self.assertEqual(messages.get_message_type_from_id(34), GameChatMessage)
        self.assertEqual(messages.get_message_type_from_id(35), LobbyChatMessage)
        self.assertEqual(messages.get_message_type_from_id(36), GrabPieceMessage)
        self.assertEqual(messages.get_message_type_from_id(37), ReleasePieceMessage)
        self.assertEqual(messages.get_message_type_from_id(38), SwitchPlayerMessage)
        self.assertEqual(messages.get_message_type_from_id(39), RecursiveDoneMessage)

        self.assertEqual(messages.get_message_type_from_id(40), SwitcherooMessage)
        self.assertEqual(messages.get_message_type_from_id(41), RemoveOneWayWallMessage)
        self.assertEqual(messages.get_message_type_from_id(42), BankruptActionMessage)
        self.assertEqual(messages.get_message_type_from_id(43), RemovePlayerMessage)
        self.assertEqual(messages.get_message_type_from_id(44), PowerNoEffectMessage)
        self.assertEqual(messages.get_message_type_from_id(45), NukeMessage)
        self.assertEqual(messages.get_message_type_from_id(46), JumpOnPieceMessage)
        self.assertEqual(messages.get_message_type_from_id(47), GetPowerSquareMessage)
        self.assertEqual(messages.get_message_type_from_id(48), SettingsLoadedMessage)
        self.assertEqual(messages.get_message_type_from_id(49), AssignPowerSquareMessage)

        self.assertEqual(messages.get_message_type_from_id(50), AssignNextPowerCountMessage)
        self.assertEqual(messages.get_message_type_from_id(51), NewGridCoordMessage)
        self.assertEqual(messages.get_message_type_from_id(52), ResignMessage)
        self.assertEqual(messages.get_message_type_from_id(53), ChallengeMessage)
        self.assertEqual(messages.get_message_type_from_id(54), ChallengeAuthMessage)
        self.assertEqual(messages.get_message_type_from_id(55), SettingsReadyOffMessage)
        self.assertEqual(messages.get_message_type_from_id(56), SettingsArenaSizeMessage)
        self.assertEqual(messages.get_message_type_from_id(57), SettingsSquadronSizeMessage)
        self.assertEqual(messages.get_message_type_from_id(58), SettingsTimerMessage)
        self.assertEqual(messages.get_message_type_from_id(59), SettingsTopBottomMessage)

        self.assertEqual(messages.get_message_type_from_id(60), SettingsColorMessage)
        self.assertEqual(messages.get_message_type_from_id(61), SettingsReadyOnMessage)
        self.assertEqual(messages.get_message_type_from_id(62), SettingsReadyOnAgainMessage)
