...
export default function OrbsPage() {
  ...
  return (
    <div className="prose prose-invert max-w-none p-6">
      <h1 className="text-2xl font-bold mb-6 text-white">Powers List</h1>
          ...
          <div className="grid gap-2 grid-cols-2 sm:grid-cols-3 md:grid-cols-4">
            {categoryPowers.map((power) => (
              <Link
                ...
                className="block p-2 rounded-lg border border-gray-700 bg-gray-800 hover:border-blue-500 transition-colors"
              >
                <div className="flex items-center justify-between">
                  ...
                  {power.memberOnly && (
                    <span className="text-xs bg-yellow-900 text-yellow-100 px-1 py-0.5 rounded ml-1">
                      Member
                    </span>
                  )}
                </div>
