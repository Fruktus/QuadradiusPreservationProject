    ...
    <OrbLayout
      ...
      strategy={
        <p className="text-gray-400">
          Use this power to hide your piece's capabilities from your opponent.
          They won't know what powers your piece has until you use them,
          allowing you to set up unexpected combinations and traps.
        </p>
      }
    />
  );
