...
class DiscordBot:
    ...
    async def _start_tournament(self, interaction, tournament_name: str, active_until: str) -> None:
        ...
        # Fill out the initial duels
        initial_duels = indexer.get_nodes_at_level(indexer.levels - 1)
    ...
    async def _start_tournament_round(self, interaction, tournament_name: str, active_until: str) -> None:
        ...
        duels = await self.connector.list_duels()
        current_level_nodes = []
    ...
    async def _start_round_from_participants(self, tournament_id: str, participant_pairs: list, active_until: datetime):
        pass