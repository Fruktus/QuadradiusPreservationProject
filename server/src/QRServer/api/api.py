...
class ApiServer:
    ...
    def _add_routes(self):
        self.app.add_routes([
            ...
            # Invites
            web.get('/api/v1/invites/{id}/make-params', self._v1_invites_make_params),
    ...
    @authenticated
    async def _v1_invites_make_params(self, request, user: DbUser) -> web.Response:
        ...
        elif challenged.user_id == user.user_id:
