...
class Config:
    def __init__(self):
        ...
        self.api_port = ConfigKey(
            ...
            name='port.api',
            cli_args=[],
            description='port used to serve the REST API',
            default_value=4000)
        self.api_enabled = ConfigKey(
            config=self,
            name='api.enabled',
            cli_args=[],
            description='Whether to enable the REST API',
            default_value=False)
        ...
        self.discord_bot_channel_user_notifications_id = ConfigKey(
            ...
            cli_args=[],
            description='Discord Channel ID for user notifications such as registration or claiming an account',
            default_value='')
