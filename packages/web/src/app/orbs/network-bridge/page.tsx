    ...
    <OrbLayout
      ...
      strategy={
        <p className="text-gray-400">
          Connect pieces that complement each other's abilities. When one piece
          acquires new powers through Scavenger or Power Plant, both pieces will
          benefit. Be careful though - if one piece is purified, both will lose
          their powers.
        </p>
      }
    />
