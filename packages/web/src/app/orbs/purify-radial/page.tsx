...
export default function PurifyRadialPage(): JSX.Element {
  return (
      ...
      <div className="flex items-start gap-8">
        ...
        <div className="w-2/3">
          <div className="flex items-center gap-4 mb-6">
            <h1 className="text-3xl font-bold m-0">Purify Radial</h1>
          </div>

          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Description</h2>
            <p className="text-gray-400">
              Removes all powers from enemy pieces in a radial pattern around
              this piece. The range can be extended with Grow Quadradius.
            </p>
          </div>
