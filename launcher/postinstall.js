...
const ruffleDistribution = `ruffle-nightly-2024_03_02-${rufflePlatform}-x86_64.${ruffleFormat}`
const ruffleUrl = `https://github.com/ruffle-rs/ruffle/releases/download/nightly-2024-03-02/${ruffleDistribution}`
