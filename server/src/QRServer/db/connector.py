...
class DbConnector:
    ...
    async def connect(self):
        ...
        await migrations.setup_metadata(self)
        await migrations.execute_migrations(self)
    ...
    async def add_match_result(self, match_result: DbMatchReport):
        ...
        if (not ranked_only or match_result.is_ranked) and (not include_void or not match_result.is_void):
